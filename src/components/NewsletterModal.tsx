...
export default function NewsletterModal() {
  ...
  return (
    <>
      {toast && (
        <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-60 flex items-center gap-4 bg-black text-white text-sm px-5 py-3.5 shadow-lg font-[Montserrat]">
          <span>You&apos;re subscribed! Welcome to AI Minimalist.</span>
          <button
